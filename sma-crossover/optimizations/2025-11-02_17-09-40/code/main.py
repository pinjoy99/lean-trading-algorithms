...
class Smacrossover(QCAlgorithm):
    ...
    def initialize(self):
        ...
        # Using shorter periods for more responsive signals
        self.fast_sma = self.SMA(self.symbol, 5, Resolution.MINUTE)   # 5-minute fast SMA
        self.slow_sma = self.SMA(self.symbol, 15, Resolution.MINUTE)  # 15-minute slow SMA
